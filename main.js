...
global.channelLink = "https://whatsapp.com/channel/0029VbBxyNIHltY20OdLqJ27";
global.ytch = "precieux Labs";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029VbBxyNIHltY20OdLqJ27'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/HO9ARK5yCYq9Gxq0F3CbMi?mode=gi_t`
                }, { quoted: message });
                return;
            }
        }
